...
<head>
    ...
    <!-- Bootstrap CSS-->
    <link href="dist/vendor/bootstrap-4.1/bootstrap.min.css" rel="stylesheet" media="all">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="dist/images/icon/logo.png" alt="CoolAdmin">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <button> <a href="{{url("template")}}" class="au-btn au-btn--block au-btn--green m-b-20" >sign in</a> 
